...
<script type="application/json" id="kk-config"><?= json_encode([
    'compareUrl'   => url($en ? 'en/compare' : 'vergleich'),
    'compareLabel' => $en ? 'Compare' : 'Vergleichen',
    'clearLabel'   => $en ? 'Clear' : 'Leeren',
    'removeLabel'  => $en ? 'Remove' : 'Entfernen',
    'detailsLabel' => $en ? 'Details' : 'Details',
    'maxLabel'     => $en ? 'You can compare up to 3 models.' : 'Du kannst bis zu 3 Modelle vergleichen.',
    'rows' => [
        'drive' => $en ? 'Drive' : 'Antrieb',
        'brand' => $en ? 'Brand' : 'Marke',
        'ps'    => $en ? 'Power (hp)' : 'Leistung (PS)',
        'kw'    => 'kW',
        'kg'    => $en ? 'Weight (kg)' : 'Gewicht (kg)',
        'avail' => $en ? 'Availability' : 'Verfügbarkeit',
        'price' => $en ? 'Price' : 'Preis',
    ],
