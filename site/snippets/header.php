...
<header class="site-header" data-header>
    ...
    <div class="topbar">
        <div class="container topbar__row">
            <span class="topbar__item"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.8 19.8 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.8 19.8 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13.96.36 1.9.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.91.34 1.85.57 2.81.7A2 2 0 0 1 22 16.92z"/></svg><a href="tel:+4940609019969"><?= $en ? 'Advice: +49 40 60 90 199 69' : 'Beratung: +49 40 60 90 199 69' ?></a></span>
    ...
    <div class="headbar">
        <div class="container headbar__row">
            ...
            <div class="header-actions">
                ...
                <a class="iconlink iconlink--wl" href="<?= $u('merkliste', 'wishlist') ?>" aria-label="<?= $en ? 'Wishlist' : 'Merkliste' ?>" title="<?= $en ? 'Wishlist' : 'Merkliste' ?>"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.8 4.6a5.5 5.5 0 0 0-7.8 0L12 5.6l-1-1a5.5 5.5 0 0 0-7.8 7.8l1 1L12 21l7.8-7.6 1-1a5.5 5.5 0 0 0 0-7.8z"/></svg><span class="iconlink__count" data-wl-count hidden>0</span></a>
